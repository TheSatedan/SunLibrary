...
class resources extends SunLibraryModule
{
    ...
    public function resources()
    {
        ?>
        <b>Resources</b>
        <a href="web-settings.php?id=Resources&&moduleID=AddResource">
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="1">
            ...
            while ($checkRow = $stmt->fetch()) {
                ?>
                <tr bgcolor=white style="cursor: pointer;"
                    onclick="location.href='web-settings.php?id=Resources&&moduleID=EditResource&&resourceID=<?= $resourceID; ?>'">
                    <td width="200">
                        <?= $resourceName; ?>
                    </td>
                    <td>
