 ...
 * @version         1.1.2               2018-05-25 14:34:00 CST SM:  PSR fixes, fixes to use the FileAttributes.
 */

require_once 'FileAttributeTools.php';

use FileAttributeTools\FileAttributes AS FA;
